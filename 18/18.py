...
def findProducts(currentPath, row, column, direction):

	column += direction
	currentPath *= pyramid[row][column]

	if row < 14:
		findProducts(currentPath, row + 1, column, 0)
		findProducts(currentPath, row + 1, column, 1)
	else:
		print(currentPath)
		# if currentPath > bestPath:
			# bestPath = currentPath

findProducts(1, 0, 0, 0)
